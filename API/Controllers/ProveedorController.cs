...
namespace API.Controllers
{
    ...
    public class ProveedorController : BaseApiController
    {
        ...
        {
            var registros = await _unitOfWork.Proveedor.GetAllAsync();
        ...
        {
            var registro = await _unitOfWork.Proveedor.GetByIdAsync(id);
        ...
        public async Task<ActionResult<ProveedorDto>> Post(ProveedorDto data)
        {
            ...
            var addRegistro = _mapper.Map<Proveedor>(data);
            _unitOfWork.Proveedor.Add(addRegistro);
        ...
        public async Task<ActionResult<ProveedorDto>> Put(int id, [FromBody] ProveedorDto updateData)
        {
            if(updateData == null) return BadRequest();
            var registro = _mapper.Map<Proveedor>(updateData);
            registro.Id = id;
            _unitOfWork.Proveedor.Update(registro);
            await _unitOfWork.SaveAsync();
            return updateData;
        }
        ...
        public async Task<ActionResult> Delete(int id)
        {
            ...
            _unitOfWork.Proveedor.Remove(registro);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<Pager<ProveedorDto>>> GetPager([FromQuery] Params pagerParams)
        {
            var registros = await _unitOfWork.Proveedor.GetAllAsync
            (
            ...
            var lista = _mapper.Map<List<ProveedorDto>>(registros.registers);
